...
function IngameContractGui:init(ws)
	...
	if managers.job:is_current_job_professional() then
		...
		if not is_job_heated or not heat_warning_text:bottom() then
		end
	...
	if (not pro_warning_text or not pro_warning_text:visible() or not pro_warning_text:bottom()) and (not heat_warning_text or not heat_warning_text:visible() or not heat_warning_text:bottom()) then
	end
