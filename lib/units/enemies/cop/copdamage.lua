...
function CopDamage:damage_bullet(attack_data)
	...
	if self._has_plate then
		...
		if attack_data.attacker_unit == managers.player:player_unit() then
			...
			armor_pierced = not alive(attack_data.weapon_unit) or not attack_data.weapon_unit:base().got_silencer or not attack_data.weapon_unit:base():got_silencer() or armor_pierced or math.rand(1) < managers.player:upgrade_value("weapon", "armor_piercing_chance_silencer", 0)
		end
